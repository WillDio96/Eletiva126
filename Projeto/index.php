...
<head>
    ...
    <title>Login – Sistema de Gestão de Hotéis</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet">
</head>
<body class="bg-light d-flex align-items-center justify-content-center vh-100">

<div class="card p-4 shadow" style="width: 100%; max-width: 400px;">
    <h3 class="text-center mb-1">🏨 Gestão de Hotéis</h3>
    <p class="text-center text-muted small mb-4">William Oliveira Dionisio</p>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if ($email == "adm@adm" && $senha == "123") {
            ...
            echo "<p class='text-danger mt-3 text-center'>Email e/ou senha incorretos!</p>";
        }
    }
    ?>
</div>
